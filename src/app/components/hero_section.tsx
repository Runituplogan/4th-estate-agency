  ...
  return (
    <nav className="absolute top-0 left-0 w-full flex items-center md:justify-around justify-between p-6 bg-transparent z-20">
      <Wrapper className="flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-4">
          <Link href="/login">
            <button className="cursor-pointer px-4 py-2 text-sm text-white border border-white rounded-lg hover:bg-white hover:text-[#385065] transition-colors">
              Login
            </button>
          </Link>
          <Link href="/register">
            <button className="cursor-pointer px-4 py-2 text-sm bg-[#385065] text-white rounded-lg hover:bg-[#2e4357] transition-colors">
              Register
            </button>
          </Link>
        </div>

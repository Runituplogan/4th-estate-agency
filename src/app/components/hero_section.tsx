...
export default function HeroLayout({ backgroundImage, full,children }: HeroLayoutProps) {
  return (
    <section
      className={`relative ${full ? "md:!h-screen" : "md:!h-[75vh]"} w-full bg-cover bg-center flex flex-col items-center justify-center text-white text-center before:absolute before:bg-bg1 before:inset-0 before:pointer-events-none !h-[70vh]`}
